...
const CardProduct = (props) => {
  ...
  return (
    <div className='w-full max-w-sm bg-gray-500 border border-gray-400 rounded-lg shadow'>
      {children}
    </div>
  );
};
...
const Footer = (props) => {
  ...
  return (
    <div className='flex items-center justify-between px-5 py-5'>
      ...
      <Button type='submit' variant='bg-blue-600' hover='hover:bg-blue-800' width='w-50%'>
        Add To Cart
      </Button>
    </div>
  );
